  ...
  <div v-loading="loading">
    ...
    <div>
      <el-table :data="retTable" @selection-change="dataSelect" stripe border fit :height="View_TableHeight" @sort-change="sortChange">
        ...
        <el-table-column prop="specName" width="80" label="规格" sortable="custom" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="unitName" min-width="50" label="单位" sortable="custom" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="hospitalUnitPrice" min-width="80" label="单价" align="right" sortable="custom" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="deliveryMemberName" min-width="160" label="配送企业" sortable="custom" show-overflow-tooltip>
        </el-table-column>
    ...
    <div class="table-footer">
      ...
      <div style="float: left">
        <span>总金额：</span>{{purchaseAmounts || 0}}
        <span>元</span>
      </div>
    </div>
...
export default {
  ...
  watch: {
    ...
    getProjectId() {
      if (this.$route.path === '/Contract/TriContractList/CreateContract') {
        this.fromEdit.projectId = this.getProjectId; // 获取当前切换的集采项目号码
      }
    },
