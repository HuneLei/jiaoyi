    ...
    data() {
      return {
        ...
        editMessage: {
          ...
          rules: {
//            orderFile: [
//              { required: true, message: '请上传随货同行单',
// validator: window.validator.enclosure, trigger: 'change' },
//            ],
          },
          styleObject: {},
        },
    ...
    methods: {
      ...
      dataUpdate(row) {
        ...
        GpoStockinList.listItem(filterForm).then((res) => {
          if (res.data.code === 0) {
      ...
      dialogConfirm(formName) {
        // console.log();
        GpoStockinList.update(this.form.id, this.form.orderFile).then((res) => {
          if (res.data.code === 0) {
