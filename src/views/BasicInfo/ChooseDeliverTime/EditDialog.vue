...
import ChooseDeliverTime from '../../../api/BasicInfo/ChooseDeliverTime'; // 药品上架管理APi
...
export default {
  ...
  methods: {
    ...
    dataDialogList(msg, form, page, size) {
      ...
      formlist.brr = this.options.brr;
      ChooseDeliverTime.drugsList(page || 0, size || 10, formlist).then((res) => {
        if (res.data.code === 0) {
