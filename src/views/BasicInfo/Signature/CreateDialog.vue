  ...
  <div>
    <DialogForm :dialog-form-visible="dialogFormShow" @close-dialog="CloseDialog" @dialog-confirm="dialogConfirm" @dialog-cancel="dialogCancel" :message="editMessage" :from-dialog="form" :isFormConfirm="true" :formConfirmLoading="formConfirmLoading">
        ...
        <el-form-item label="附件" prop="enclosure" slot='enclosure' label-width="115px">
          <YUploadEdit :fileList="uploadData" :image="true" :pdf="false" :showBriefOther="true" @upload-result="uploadResult" :multi="false" :isDisabled="false" :isReadonly="false"></YUploadEdit>
      </el-form-item>
    </DialogForm>
  ...
  export default {
    ...
    methods: {
      ...
      dialogConfirm(formName) {
        ...
        Signature.create(this.form.enclosure, this.form.memberId,
