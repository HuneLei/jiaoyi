<template>
  <div v-loading="loading">
    <el-form :rules="editMessage.rules" label-width="120px" id="from-item">
      <TradeEditsForm :from-edit="fromEdit" :isCreatShow="true" :isDeleteItem="true" :message="editMessage" :isGoBackShow="false" :arrow-num=5 :arrow-down="true" @delete-item="deleteItem" @data-creat="dataCreat" @show-more="showMore">
    ...
    <div>
      <el-table :data="tableData" @selection-change="dataSelect" stripe border fit :height="View_TableHeight" @sort-change="sortChange">
        ...
        <el-table-column min-width="120" label="操作" show-overflow-tooltip>
...
export default {
  ...
  watch: {
    ...
    projectId(newinfo, oldinfo) {
      ...
      if (this.$route.path === '/Deliverrelation/HospitalChangeDelivery/Create') {
  ...
  methods: {
    ...
    orderSave() {
      ...
      this.loading = true;
      if (this.$route.path === '/Deliverrelation/HospitalChangeDelivery/Create') {
        // console.log('this.fromEdit', this.fromEdit, this.projectName);
        const form = {
          arr: this.tableData,
