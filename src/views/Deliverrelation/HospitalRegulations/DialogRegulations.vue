...
export default {
  ...
  methods: {
    ...
    dataChoose(form) {
      ...
      switch (form.type) {
        case 1:
          this.optionsDialog.title = '已选品规';
          break;
        case 2:
          this.optionsDialog.title = '未选品规';
          break;
        case 3:
          this.optionsDialog.title = '合同品规';
          break;
        case 4:
          this.optionsDialog.title = '订单品规';
          break;
        default:
          break;
      }
    ...
    dataDialogList(msg, form, page, pageSizes) {
      ...
      if (this.optionsDialog.title === '未选品规') {
        forms.createDate = null;
      }
      HospitalRegulations.numList(cpage, cpageSizes, forms)
        .then((res) => {
          if (res.data.code === 0) {
