<template>
  <el-table :data="tableData" v-loading="loading" :height="tableHeight" stripe border fit @sort-change="sortChange">
    ...
    <el-table-column align="left" prop="hospitalMemberName" label="填报单位" sortable="custom" min-width="120" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="fillTime" label="填报日期" align="left" min-width="130" sortable="custom" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="name" label="患者姓名" align="left" min-width="90" sortable="custom" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="sex" label="性别" align="left" min-width="90" sortable="custom" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="age" label="年龄" align="left" min-width="90" sortable="custom" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="weight" label="体重" align="left" min-width="90" sortable="custom" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="left" prop="contactInformation" label="联系方式" sortable="custom" min-width="100" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="left" prop="reportPerson" label="报告人" sortable="custom" min-width="120" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="left" prop="reportPhone" label="电话/传真" sortable="custom" width="100" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="left" prop="makePerson" label="制表人" sortable="custom" min-width="120" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="left" prop="makeTime" label="制表日期" sortable="custom" class-name="table_right" width="140" show-overflow-tooltip>
    </el-table-column>
    <el-table-column align="center" min-width='160' fixed="right" label="详情">
...
export default {
  ...
  methods: {
    ...
    dataList(page, pageSizes) {
      ...
      DrugsHarmfulResponse.list(cpage, cpageSizes, this.filterForm).then((res) => {
        if (res.data.code === 0) {
    ...
    dataCreate() {
      this.$router.push({ path: '/SurveyReport/DrugsHarmfulResponse/Create' });
    },
    /**
     *  编辑
     * @param item
     */
    dataUpdate(item) {
      this.$router.push({ path: '/SurveyReport/DrugsHarmfulResponse/Edit', query: { id: item.id } });
    },
    // 转换日期 YYYY-MM-DD
    convertDate(str) {
