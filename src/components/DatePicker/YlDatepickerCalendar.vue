...
<div :class="`${pre}`">
  <div :class="`${pre}-head`">
    <a :class="`${pre}-prev-decade-btn`" v-show="showYears" @click="year-=10"><i class="fa fa-angle-double-left"></i></a>
    <a :class="`${pre}-prev-year-btn`" v-show="!showYears" @click="year--"><i class="fa fa-angle-double-left"></i></a>
    <a :class="`${pre}-prev-month-btn`" v-show="!showYears&&!showMonths" @click="pm"><i class="fa fa-angle-left"></i></a>
    ...
    <a :class="`${pre}-next-month-btn`" v-show="!showYears&&!showMonths" @click="nm"><i class="fa fa-angle-right"></i></a>
    <a :class="`${pre}-next-year-btn`" v-show="!showYears" @click="year++"><i class="fa fa-angle-double-right"></i></a>
    <a :class="`${pre}-next-decade-btn`" v-show="showYears" @click="year+=10"><i class="fa fa-angle-double-right"></i></a>
  </div>
  <div :class="`${pre}-body`">
    <div :class="`${pre}-days`">
