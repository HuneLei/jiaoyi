...
var initialObj = function () {
  return new ActiveXObject("NetcaPki.Utilities");
};
...
const key = function signNETCA() {
  ...
  var key = getX509CertificateInfo(oCert, 9);

  return key;
};

const oCert = function signNETCA() {
  var oCert;
  try {
    oCert = initialObj().CreateCertificateObject();
  }
